...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'POSNotification'
        db.create_table(u'pos_posnotification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('types', self.gf('django.db.models.fields.SmallIntegerField')(db_index=True)),
            ('pos', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pos.POS'])),
            ('internal_ident', self.gf('django.db.models.fields.CharField')(max_length=14)),
            ('to', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('foreign_iden', self.gf('django.db.models.fields.CharField')(default='', max_length=12, blank=True)),
            ('dismissed', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
        ))
        db.send_create_signal(u'pos', ['POSNotification'])

        # Adding unique constraint on 'POSNotification', fields ['pos', 'internal_ident', 'to']
        db.create_unique(u'pos_posnotification', ['pos_id', 'internal_ident', 'to'])


    def backwards(self, orm):
        # Removing unique constraint on 'POSNotification', fields ['pos', 'internal_ident', 'to']
        db.delete_unique(u'pos_posnotification', ['pos_id', 'internal_ident', 'to'])

        # Deleting model 'POSNotification'
        db.delete_table(u'pos_posnotification')
    ...
    models = {
        ...
        u'pos.posnotification': {
            ...
            'types': ('django.db.models.fields.SmallIntegerField', [], {'db_index': 'True'})
        }
    }
