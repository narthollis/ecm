...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'POSNotification.foreign_iden'
        db.alter_column(u'pos_posnotification', 'foreign_iden', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'POSNotification.foreign_iden'
        db.alter_column(u'pos_posnotification', 'foreign_iden', self.gf('django.db.models.fields.CharField')(max_length=12))
    ...
    models = {
        ...
        u'pos.posnotification': {
            ...
            'foreign_iden': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
